    ...
    <>
      ...
      <section ref={sectionRef} id="skills" className="py-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-24 h-24 glass rotate-45 opacity-15 float-animation interactive-3d"></div>
          ...
          <div className="absolute bottom-60 left-20 w-16 h-16 glass rotate-12 opacity-10 float-animation interactive-3d" style={{ animationDelay: '4s' }}></div>
          ...
          <div className="absolute top-60 left-1/2 w-14 h-14 glass rotate-45 opacity-12 float-animation interactive-3d" style={{ animationDelay: '3s' }}></div>
